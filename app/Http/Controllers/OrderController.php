...
class OrderController extends Controller
{
    ...
    public function downloadPDF($id)
    {
        ...
        return $pdf->stream('receipt.pdf');// stream berguna untuk melihat terlebih dahulu sebelum mendownload. 
                                           // jika ingin langsung mendownload gunakan perintah download
    }

    public function search(Request $request)
    {
        $searchTerm = $request->input('search');
        $orders = Order::where('created_at', 'like', '%' . $searchTerm . '%')->paginate(10);
